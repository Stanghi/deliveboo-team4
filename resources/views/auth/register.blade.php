                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="iva" type="text"
                                        class="form-control @error('restaurant_name') is-invalid @enderror" name="iva"
                            ...
                            <div class="mb-4 row">
                                <label for="img" class="col-md-4 col-form-label text-md-right"><i
                                        class="fa-solid fa-utensils"></i> {{ __('Immagine') }} </label>

                                <div class="col-md-6">
                                    <input id="img" type="file" onchange="showImage(event)"

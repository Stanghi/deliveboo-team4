...
<div style="margin-top: 30px; text-align: center;">
    <a style="text-align: center; text-decoration: none; font-weight:bold; padding: 10px; border-radius: 10px; background-color:#f15a25; color:#ffffff;"  href="http://127.0.0.1:8000/admin/orders/{{$order->id}}">Accedi alla tua area personale</a>
</div>
